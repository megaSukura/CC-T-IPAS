...
return function(name, basalt)
    ...
    base:addProperty("AutoScrollbar", "boolean", true)
        ...
        draw = function(self)
            ...
            self:addDraw("scrollableFrameScrollbar", function()
                if self:getAutoCalculate()  then
                    if self:getAutoScrollbar() then
                        if self:getDirection() == "horizontal" and getHorizontalScrollAmount(self) > 0 then
                            self:setScrollbar(true)
                            
                        elseif self:getDirection() == "vertical" and getVerticalScrollAmount(self) > 0 then
                            self:setScrollbar(true)
                        else
