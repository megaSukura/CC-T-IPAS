...
return function(name, basalt)
    ...
    local activeEvents = setmetatable({}, {__mode="v"})
    local properties = {}
    ...
    object = {
        ...
        addProperty = function(self, name, typ, defaultValue, readonly, setLogic, getLogic, alteredRule,isDyValue)
            name = name:gsub("^%l", string.upper)
            ...
            self:setProperty(name, defaultValue,nil,isDyValue)
            ...
            if(not readonly)then
                object["set" .. name] = function(self, value, ...)
                    if(self~=nil)then
                        ...
                        self:setProperty(name, value, alteredRule~=nil and alteredRule(typ) or defaultRule(typ),isDyValue)
                    end
                    return self
                end
            end
