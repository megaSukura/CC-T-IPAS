...
local filePath = "/lib/basalt1_6_5.lua" --here you can change the file path default: basalt
...
visualButton(objFrame:addButton("exampleButton"):setText("Button"):setSize(12,3):setPosition(2,2):onClick(function() basalt:stopUpdate() end):show())
...
local prog = objFrame:addProgressbar("exampleProgressbar"):setAnchor("bottomLeft"):setSize(30, 3):setBackground(colors.black):setPosition(2,3):onProgressDone(function()
basalt.debug("Progress done!")
end):show()


local timer = objFrame:addTimer("exampleTimer"):setTime(0.1, -1):onCall(function()
    prog:setProgress(prog:getProgress()+2)
    basalt.debug(prog:getProgress())
